...
const CSS_STUB_SUITES = new Set(["plugin-settings-actions.test.tsx", "connection-model-picker.test.tsx", "provider-display-name.test.tsx", "provider-editor-compact.test.tsx", "provider-model-discovery-selection.test.tsx", "provider-onboarding.test.tsx", "settings-provider-normalization.test.ts", "provider-image-input.test.tsx", "heartbeat-editor.test.tsx", "heartbeat-next-run.test.ts", "settings-page-navigation.test.tsx", "automation-management.test.tsx", "trash-management.test.tsx", "capabilities-panel-actions.test.ts", "provider-access-card.test.tsx", "provider-editor-model-picker.test.tsx", "provider-name-readonly.test.tsx", "settings-refresh-snapshot.test.tsx", "shell-support-install.test.tsx", "shortcuts-recorder-focus.test.tsx"]);
